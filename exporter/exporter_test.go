...
const (
	...
	GoodDeviceInfoExpected = `
        ...
        device_info{biosVersion="U99 v0.00 (xx/xx/xxxx)",chassisModel="model a",chassisSerialNumber="SN99999",firmwareVersion="iLO 5 v2.65",name="test description"} 1
	`
	...
	GoodStorageBatteryStatusExpected = `
        ...
        redfish_storage_battery_status{chassisModel="model a",chassisSerialNumber="SN98765",id="1",model="battery model",name="HPE Smart Storage Battery ",serialnumber="123456789"} 1
	`
	GoodMemoryDimmExpected = `
        ...
        redfish_memory_dimm_status{capacityMiB="32768",chassisModel="model a",chassisSerialNumber="SN98765",manufacturer="HPE",name="proc1dimm1",partNumber="part number",serialNumber="123456789"} 1
	`
	...
	GoodPowerSupplyOutputExpected = `
        ...
        redfish_power_supply_output{chassisModel="model a",chassisSerialNumber="SN98765",manufacturer="DELTA",model="psmodel",name="HpeServerPowerSupply",partNumber="part number",powerSupplyType="AC",serialNumber="123456789"} 91
	`
	GoodPowerSupplyStatusExpected = `
        ...
        redfish_power_supply_status{chassisModel="model a",chassisSerialNumber="SN98765",manufacturer="DELTA",model="psmodel",name="HpeServerPowerSupply",partNumber="part number",powerSupplyType="AC",serialNumber="123456789"} 1
	`
	GoodPowerSupplyTotalConsumedExpected = `
        ...
        redfish_power_supply_total_consumed{chassisModel="model a",chassisSerialNumber="SN98765",memberId="0"} 206
	`
)
...
func Test_DL360_Exporter(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			var err error
			exporter, err = NewExporter(ctx, server.URL, test.uri, "", "model a")
			assert.Nil(err)
