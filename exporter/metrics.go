...
func NewDeviceMetrics() *map[string]*metrics {
	var (
		...
		PowerMetrics = &metrics{
			...
			"supplyOutput":        newServerMetric("redfish_power_supply_output", "Power supply output in watts", nil, []string{"name", "chassisSerialNumber", "chassisModel", "manufacturer", "partNumber", "serialNumber", "powerSupplyType", "model"}),
			"supplyStatus":        newServerMetric("redfish_power_supply_status", "Current power supply status 1 = OK, 0 = BAD", nil, []string{"name", "chassisSerialNumber", "chassisModel", "manufacturer", "partNumber", "serialNumber", "powerSupplyType", "model"}),
		...
		StorageBatteryMetrics = &metrics{
			"storageBatteryStatus": newServerMetric("redfish_storage_battery_status", "Current storage battery status 1 = OK, 0 = BAD", nil, []string{"id", "chassisSerialNumber", "chassisModel", "name", "model", "serialnumber"}),
		}
		...
		DiskDriveMetrics = &metrics{
			"driveStatus": newServerMetric("redfish_disk_drive_status", "Current Disk Drive status 1 = OK, 0 = BAD, -1 = DISABLED", nil, []string{"name", "chassisSerialNumber", "chassisModel", "id", "location", "serialnumber"}), // DiskDriveStatus values
		}

		// Logical Disk Drive Metrics
		LogicalDriveMetrics = &metrics{
			"raidStatus": newServerMetric("redfish_logical_drive_status", "Current Logical Drive Raid 1 = OK, 0 = BAD, -1 = DISABLED", nil, []string{"name", "chassisSerialNumber", "chassisModel", "logicaldrivename", "volumeuniqueidentifier", "raid"}), // Logical Drive Raid value
		}
		...
		MemoryMetrics = &metrics{
			...
			"memoryDimmStatus": newServerMetric("redfish_memory_dimm_status", "Current dimm status 1 = OK, 0 = BAD", nil, []string{"name", "chassisSerialNumber", "chassisModel", "capacityMiB", "manufacturer", "partNumber", "serialNumber"}),
		}
