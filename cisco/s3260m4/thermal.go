...
// ThermalMetrics is the top level json object for UCS S3260 M4 Thermal metadata
...
// Fan is the json object for a UCS S3260 M4 fan module
type Fan struct {
	Name         string      `json:"Name"`
...
// Temperature is the json object for a UCS S3260 M4 temperature sensor module
