...
const (
	...
	GoodLogicalDriveExpected = `
		 ...
		 dl560_logical_drive_status{chassisSerialNumber="SN98765",logicaldrivename="TESTDRIVE NAME 1",name="HpeSmartStorageLogicalDrive",raid="1",volumeuniqueidentifier="ABCDEF12345"} 1
	`
	GoodDiskDriveExpected = `
		 ...
		 dl560_disk_drive_status{chassisSerialNumber="SN98765",id="0",location="1I:1:1",name="HpeSmartStorageDiskDrive",serialnumber="ABC123"} 1
	`
	GoodNvmeDriveExpected = `
		 ...
		 dl560_nvme_drive_status{chassisSerialNumber="SN98765",id="DA000000",protocol="NVMe",serviceLabel="Box 3:Bay 7"} 1
	`
)
...
func Test_DL560_Metrics_Handling(t *testing.T) {
