...
// exportPowerMetrics collects the DL560's power metrics in json format and sets the prometheus gauges
...
// exportThermalMetrics collects the DL560's thermal and fan metrics in json format and sets the prometheus gauges
...
// exportMemoryMetrics collects the DL560 drive metrics in json format and sets the prometheus gauges
