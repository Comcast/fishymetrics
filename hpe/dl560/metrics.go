...
func NewDeviceMetrics() *map[string]*metrics {
	var (
		...
		PowerMetrics = &metrics{
			...
			"supplyOutput":        newServerMetric("dl560_power_supply_output", "Power supply output in watts", nil, []string{"name", "bayNumber", "chassisSerialNumber", "manufacturer", "partNumber", "serialNumber", "powerSupplyType", "model"}),
			"supplyStatus":        newServerMetric("dl560_power_supply_status", "Current power supply status 1 = OK, 0 = BAD", nil, []string{"name", "bayNumber", "chassisSerialNumber", "manufacturer", "partNumber", "serialNumber", "powerSupplyType", "model"}),
