...
// NetworkAdapter is the top level json object for DL560 Network Adapter metadata
...
// Firmware is the top level json object for DL560 Network Adapter metadata
