...
func NewDeviceMetrics() *map[string]*metrics {
	var (
		...
		ProcessorMetrics = &metrics{
			"processorStatus": newServerMetric("xl420_cpu_status", "Current cpu status 1 = OK, 0 = BAD", nil, []string{"id", "chassisSerialNumber", "socket", "model", "totalCores"}),
		}

		IloSelfTestMetrics = &metrics{
			"iloSelfTestStatus": newServerMetric("xl420_ilo_selftest_status", "Current ilo selftest status 1 = OK, 0 = BAD", nil, []string{"name", "chassisSerialNumber"}),
		}

		StorageBatteryMetrics = &metrics{
			"storageBatteryStatus": newServerMetric("xl420_storage_battery_status", "Current storage battery status 1 = OK, 0 = BAD", nil, []string{"id", "chassisSerialNumber", "name", "model", "serialnumber"}),
		}
