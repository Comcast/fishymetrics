 ...
 */
 ...
 func (e *Exporter) scrape() {
	 ...
	 for _, task := range e.pool.Tasks {
		 ...
		 // TODO: Make sure these align with above metric types
 ...
 func (e *Exporter) exportPowerMetrics(body []byte) error {
  ...
  // TODO: Modify the below ThermalMetrics to fit the DL380 data
 ...
 func (e *Exporter) exportThermalMetrics(body []byte) error {
  ...
  // TODO: Modify the below DriveMetrics to fit the DL380 data
